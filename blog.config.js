...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '306d6fe0c1c08146b838eba3406e56ad',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '修一场青春的苦行', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://777682.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '千梦,博客,qianmeng,千梦网络,千梦博客', // 网站关键词 英文逗号隔开
  ...
  // 文章列表相关设置
  CAN_COPY: process.env.NEXT_PUBLIC_CAN_COPY || ture, // 是否允许复制页面内容 默认允许，如果设置为false、则全栈禁止复制内容。
